      ...
      <form method="POST" enctype="multipart/form-data" class="p-5 bg-white">
        ...
        <div class="row form-group">
          <div class="col-md-12">
            ...
            <input type="text" name="full_name" class="form-control" placeholder="Только русские буквы" value="<?=$input['full_name'] ?? ''?>">
            <span class="input_error"><?=$errors['full_name'] ?? ''?></span>
          </div>          
        </div>        
        ...
        <div class="row form-group">
          <div class="col-md-12">
            ...
            <input type="email" name="email" class="form-control" placeholder="example@mail.ru" value="<?=$input['email'] ?? ''?>">
        ...
        <div class="row form-group">
          <div class="col-md-12">
            <label class="text-black">Фото</label> 
            <input type="file" name="avatar" class="form-control">
            <span class="input_error"><?=$errors['avatar'] ?? ''?></span>
          </div>
        </div>
